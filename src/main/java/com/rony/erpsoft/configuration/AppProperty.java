...
public class AppProperty {
    ...
    public void addCommonObjects(Model model, HttpServletRequest request, HttpServletResponse resp, HttpSession httpSession) {
        ...
        model.addAttribute("ORGANIZATION_NAME", sessionService.getOrganization() != null ? sessionService.getOrganization().getName() : "");
        model.addAttribute("CURRENT_DATE", AppUtil.getDateStringByPattern(new Date(), "EEEE, MMM d, yyyy"));
