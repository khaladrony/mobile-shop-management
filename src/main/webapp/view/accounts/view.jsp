...
<script src="${NG_SRC}/accounts/constant.js?v=${SCRIPT_VERSION}"></script>
...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner" style="background: #FFF;" ng-app="AccountsManagementApp">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <%--<div class="nav-search" id="nav-search" >
                    <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                        ...
                        <a class="btn btn-sm btn-primary" ui-sref="{{JCOMPONENT.acc_debit_voucher_add_view}}" ng-if="hasPermission(JMODULE_NAME,  JCOMPONENT.acc_debit_voucher_list_view)">
                            <i class="ace-icon fa fa-user-secret"></i> Voucher Create
                        </a>
...
<!-- angularJS script -->
<script src="${NG_SRC}/accounts/app.js?v=${SCRIPT_VERSION}"></script>
...
<script src="${NG_SRC}/accounts/credit_voucher/credit_voucher_form.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/credit_voucher/credit_voucher_list.controller.js?v=${SCRIPT_VERSION}"></script>

<script src="${NG_SRC}/accounts/journal_voucher/journal_voucher_form.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/journal_voucher/journal_voucher_list.controller.js?v=${SCRIPT_VERSION}"></script>

<script src="${NG_SRC}/accounts/setup/chart_of_accounts/chart_of_accounts_form.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/setup/chart_of_accounts/chart_of_accounts_list.controller.js?v=${SCRIPT_VERSION}"></script>

<script src="${NG_SRC}/accounts/transfer_voucher/transfer_voucher_form.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/transfer_voucher/transfer_voucher_list.controller.js?v=${SCRIPT_VERSION}"></script>

<script src="${NG_SRC}/accounts/setup/sub_accounts/sub_accounts_form.controller.js?v=${SCRIPT_VERSION}"></script>

<script src="${NG_SRC}/accounts/common/voucher_posting_list.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/report/account_ledger_report.form.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/accounts/report/sub_account_ledger_report.form.controller.js?v=${SCRIPT_VERSION}"></script>
