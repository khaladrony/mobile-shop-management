app.controller('AccDebitVoucherFormCtrl', function (
    ...
    $scope.saveModule = function () {
        ...
        const method = ($state.current.name === JCOMPONENT.acc_debit_voucher_update_view) ? "PUT" : "POST";
        const url = ($state.current.name === JCOMPONENT.acc_debit_voucher_update_view) ? API.ACC_DEBIT_VOUCHER_UPDATE : API.ACC_DEBIT_VOUCHER_SAVE;
