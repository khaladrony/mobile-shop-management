app.controller('AccDebitVoucherListCtrl', function (
                $scope, $http, $state, $timeout, $rootScope, $mdDialog,
                DialogBox, $interval, Communication, growl, AccountsService
                ) {
    ...
    $scope.getDataList = function (currentPage, itemPerPage) {
        const api = API.ACC_DEBIT_VOUCHER_FILTER;
