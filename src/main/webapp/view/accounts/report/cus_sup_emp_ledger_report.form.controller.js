app.controller('AccReportCusSupEmpLedgerFormCtrl', function ($scope, $http, $state, $timeout, $stateParams, $rootScope, $sce, $mdDialog, $interval, ClientService, DialogBox, Communication, growl) {
    ...
    $scope.subAccountLedgerPreview = function () {
        ...
        xhttp.open("GET", API.ACC_REPORT_CUS_SUP_EMP_WISE_LEDGER + '/' + $scope.search.fromDate + '/' + $scope.search.toDate + '/' + $scope.search.subAccountsId + '/' + $scope.search.accountsSource, true);
