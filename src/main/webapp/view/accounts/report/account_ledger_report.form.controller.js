app.controller('AccReportAccountLedgerFormCtrl', function ($scope, $http, $state, $timeout, $stateParams, $rootScope, $sce, $mdDialog, $interval, ClientService, DialogBox, Communication, growl) {
    ...
    $scope.accountLedgerPreview = function () {
        ...
        xhttp.open("GET", API.ACC_REPORT_ACCOUNT_WISE_LEDGER + '/' + $scope.search.fromDate + '/' + $scope.search.toDate + '/' + $scope.search.chartOfAccountsId + '/' + $scope.search.chartOfAccountsCodeName, true);
