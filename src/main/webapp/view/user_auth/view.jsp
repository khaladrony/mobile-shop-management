...
<!-- include here rest of your ng app controller -->
<script src="${NG_SRC}/user_auth/feature/app_settings.controller.js?v=${SCRIPT_VERSION}"></script>
<script src="${NG_SRC}/user_auth/feature/app_audit_view.controller.js?v=${SCRIPT_VERSION}"></script>
