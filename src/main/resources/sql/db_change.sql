...
ALTER TABLE `user_info` ADD `branch_code` VARCHAR(50) NOT NULL AFTER `organization_id`;

-- user_logins
ALTER TABLE `user_logins` ADD `organization_id` BIGINT(20) NULL AFTER `user_id`;
ALTER TABLE `user_logins` ADD `branch_code` VARCHAR(50) NULL AFTER `organization_id`;
